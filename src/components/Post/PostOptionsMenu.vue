<template>
    <div class="absolute rounded-lg px-0.5 *:py-0.5 min-w-36 divide-y divide-inherit border border-slate-500 text-sm leading-4 font-medium text-slate-100 bg-slate-600">
        <div v-for="group in OptionIconList">
